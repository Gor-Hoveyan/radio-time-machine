...
export default function ArtistPage(props: Artist) {
  const { name, url, image, stats, bio, tags, similar } = props;
  console.log(props);
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow-md space-y-6  mt-8">
